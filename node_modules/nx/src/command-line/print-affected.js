...
function printAffected(affectedProjectsWithTargetAndConfig, affectedProjects, projectGraph, { nxJson }, nxArgs, overrides) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const projectNames = affectedProjects
            ...
            .map((p) => p.name);
        const tasksJson = yield createTasks(affectedProjectsWithTargetAndConfig.filter((p) => nxArgs.type ? p.type === nxArgs.type : true), projectGraph, nxArgs, nxJson, overrides);
        const result = {
            tasks: tasksJson,
